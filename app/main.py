...
class App(tk.Frame):
    ...
    def calculate_timer_settings(current_time_of_day_str, timer_day, timer_night, timer_event_start,
        ...
        # которого(init_value) - это количество дней и ночей до окончания таймера. Арифметическая прогрессия с
        # шагом(step_value). Находим значение искомый ключа - общее количество дней и ночей до окончания таймера
